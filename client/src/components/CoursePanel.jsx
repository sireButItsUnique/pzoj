	...
	return (
		<div className="bg-dark-1 rounded fixed top-[11.3rem] left-[63rem] px-[1.5rem] py-[1.5rem]">
			<div>
                ...
                <div className="">
                    {links.map((link, idx) => <>
                        <Link rel="noopener noreferrer" target="_blank" href={link.link} key={idx} className="text-blue-400 hover:underline hover:text-blue-500 transition ease-in-out duration-[800ms]">
                            {link.text}
                        </Link>
                        <br/>
                        </>
